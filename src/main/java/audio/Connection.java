...
public class Connection {
    ...
    {
        try {
            //If the message is from PrivateConstant Channel, return
            ...
            if(e.getGuild().getSelfMember().getVoiceState().getChannel() != e.getMember().getVoiceState().getChannel() //When the user and the bot are in a different channel
                    && AIBot.getGuild(e.getGuild()).getPlayer().getPlayingTrack() != null //When the PLAYER is playing
                    && !AIBot.getGuild(e.getGuild()).getPlayer().isPaused() ) { //When the PLAYER is not paused
            ...
            AIBot.getGuild(e.getGuild()).setVc(e.getMember().getVoiceState().getChannel());
            AIBot.getGuild(e.getGuild()).setTc(e.getTextChannel());

            //Open Connection
            AudioManager am = e.getGuild().getAudioManager();
            am.setAutoReconnect(true);
            am.openAudioConnection(AIBot.getGuild(e.getGuild()).getVc());
